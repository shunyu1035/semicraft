import calibration_simplefilm_GP_1009_fitting_mask
import numpy as np
...
space = [
    ...
    Real(0.0, 1, name='Rco_mask'),
    # Real(0.1, max(react_yield_p0_2, pertubation), name='pIon_SiOF'),
    # Real(0.01, 0.3, name='pIon_mask'),
    Real(0.1, 0.8, name='gamma_0_mask'),
    Real(1, 6, name='f_mask'),
    Real(0.1, 1.0, name='theta_max_mask')
]
...
def objective(params):
    ...
    loss = calibration_simplefilm_GP_1009_fitting_mask.trainProfile(iter_num, params_dict, path)
