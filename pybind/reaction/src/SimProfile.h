...
public:
    ...
    int runSimulation(int time, int ArgonID, double reflect_coefficient, int depo_or_etch,  bool diffusion, int stopPointY, int stopPointZ, double chemical_angle_v1, double chemical_angle_v2);
