...
def trainProfile(iter, preTrain_input, path):
    ...
    # 'gamma_0': 0.5154167413657552, 'f': 5.905939309223316, 'theta_max': 0.310381045478866
    sputter_yield_coefficient = np.array([[0.5536, 12.60258, 0.4457],
                                          [0.5536, 12.60258, 0.4457],
                                          [0.5536, 12.60258, 0.4457],
                                          [0.5154167413657552, 5.905939309223316, 0.310381045478866]])
    ...
    while i < 1:
        ...
        seed = 125
        react_prob_chemical[0, 0] = preTrain_input['react_prob_chemical_0'] #Si-SiFx
        react_prob_chemical[0, 1] = preTrain_input['react_prob_chemical_1'] #SiFx-vac
        ...
        # react_prob_chemical[1, 0] = preTrain_input['react_prob_chemical_10'] #Si-SioxFy
        # react_prob_chemical[1, 1] = preTrain_input['react_prob_chemical_11'] #SiFx-SioxFy
        # reflect_coefficient[2, -1] = 0.1  
        reflect_coefficient[:, :] = preTrain_input['reflect_coefficient']   
        reflect_coefficient[2, 3] = 0.1       
        ...
        sputter_yield_coefficient[2, 0] = preTrain_input['gamma_0']
        sputter_yield_coefficient[2, 1] = preTrain_input['f'] 
        sputter_yield_coefficient[2, 2] = preTrain_input['theta_max'] 
        ...
        if needrecompute == 0:
            ...
            o1 = overlap(i, img1_path, img2_path, np.array([[80, 100], [20, 50]]))
            o2 = overlap(i, img1_path, img2_path, np.array([[100, 140], [30, 60]]))
            o3 = overlap(i, img1_path, img2_path, np.array([[140, 210], [50, 60]]))

            overlap_output = (o1 + o2*4 + o3)/6
            i += 1
