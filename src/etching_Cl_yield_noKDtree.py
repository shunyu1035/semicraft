...
class etching(configuration, surface_normal):
    ...
    def etching_film(self):
        ...
        if np.any(indice_1):
            ...
            self.film, self.parcel[indice_1], update_film_etch, update_film_depo, reactList, depo_parcel = \
            self.reaction_numba(self.film, self.parcel[indice_1], get_plane, get_plane_vaccum, get_theta)
