...
from src.operations.surface_fast import surface_normal, update_normal_in_matrix_numba
...
class etching(configuration, surface_normal):
    ...
    def plane_index(self):
        ...
        return plane_indices, vacuum_indices
    ...
    def etching_film(self):
        ...
        if np.any(indice_inject):
            ...
            # vacuum_bool = self.film_label_index_normal[:, :, :, 0] == -1
            plane_indices, vacuum_indices = self.plane_index()
